...
let IndexController = require(path.resolve(__dirname, './default/controller/IndexController.js'));

// defaultModule
koaRouter.get("/", IndexController.index);
koaRouter.get("/login", IndexController.login);
